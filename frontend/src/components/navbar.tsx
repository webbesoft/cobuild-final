export default function NavBar() {
  return (
    <div>
      {/* navigation */}
      <nav className="mx-auto flex w-screen items-center justify-between p-6 lg:px-8 lg:border-b-[0.5px] lg:border-b-gray-500">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            <span className="sr-only">CoBuild</span>
            <img
              className="h-8 w-auto"
              src="/frontend/public/logo-1.png"
              alt=""
            />
          </a>
        </div>
